...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("crunchybridge");
			params.setVersion("0.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NydW5jaHlkYXRhL2NydW5jaHlicmlkZ2UiLCJ2ZXJzaW9uIjoiMC4zLjAifX0="), c => c.charCodeAt(0)));
