...
- See: `docs/dbeaver/connection-template.txt`

## 2) Saved Queries

Open `docs/dbeaver/snippets/sme_saved_queries.sql` in DBeaver’s SQL Editor and save as your personal script. It contains:
